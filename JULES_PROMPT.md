...
- [x] Phase 1: Theme & Design System Refresh
    - [x] Update `lib/core/theme.dart` with Premium Lite tokens
- [x] Phase 2: Dashboard Overhaul (Feature Parity+)
    - [x] Implement Level Badge & Name Header
    - [x] Build 5-dot Daily Streak Progress Card
    - [x] Integrate Animated Owl Mascot
    - [x] Refresh Voice/Text Input Area
- [x] Phase 3: Progress & Analytics Overhaul
    - [x] Implement Rocket Journey Card
    - [x] Build Colored Stat Grid (Streak/Stars/Questions)
    - [x] Implement Horizontal Streak Calendar
    - [x] Implement Subject Explorer Progress Bars
    - [x] Build Locked/Unlocked Achievement Grid
- [x] Phase 4: Profile & Parent Integration
    - [x] Implement Profile Avatar & Badge Header
    - [x] Build Preferences Form (Class/Board)
    - [x] Implement WhatsApp Reporting Card
- [x] Phase 5: Logic & Backend Binding
    - [x] Connect Gamification Stats to Supabase
    - [x] Implement "Send Report Now" Endpoint
